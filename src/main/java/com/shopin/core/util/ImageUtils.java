...
public class ImageUtils {
	...
	public static void saveImageAsJpg(String fromFileStr, String saveToFileStr,
		...
		srcImage = iu.imageZoomOut(srcImage, changeToWideth, changeToHeight);
	 ...
	 * @param scale 缩小比例
	 * */
	public static void saveImageAsJpg(String fromFileStr, String saveToFileStr, double scale) throws Exception {
		ImageUtils iu = new ImageUtils();
		BufferedImage srcImage;
		File saveFile = new File(saveToFileStr);
		File fromFile = new File(fromFileStr);
		...
		int imageWideth = srcImage.getWidth(null);
		int imageHeight = srcImage.getHeight(null);
		int formatWideth = (int)(imageWideth * scale);
		int formatHeight = (int)(imageHeight * scale);
		int changeToWideth = 0;
		int changeToHeight = 0;
		if (imageWideth > 0 && imageHeight > 0) {
			// flag=true;
