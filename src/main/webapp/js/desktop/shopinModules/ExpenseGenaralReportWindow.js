...
//				me.gridPanel
	...
	initComponents: function(me){
		this.expenseGenaralStore = Ext.create('Ext.data.JsonStore', {
			fields: [
				{name: 'sid', type: 'int'},{name: 'shopSid', type: 'string'},{name: 'categoryName', type: 'string'},
				{name: 'supplySid', type: 'string'},{name: 'brandSid', type: 'string'},{name: 'supplyName', type: 'string'},{name: 'brand', type: 'string'},
				{name: 'area1', type: 'float'},{name: 'expenseArea1', type: 'float'},{name: 'days1', type: 'int'},
				{name: 'area2', type: 'float'},{name: 'expenseArea2', type: 'float'},{name: 'days2', type: 'int'},
				{name: 'area3', type: 'float'},{name: 'expenseArea3', type: 'float'},{name: 'days3', type: 'int'},
                {name: 'area4', type: 'float'},{name: 'expenseArea4', type: 'float'},{name: 'days4', type: 'int'},
                {name: 'area5', type: 'float'},{name: 'expenseArea5', type: 'float'},{name: 'days5', type: 'int'},
                {name: 'area6', type: 'float'},{name: 'expenseArea6', type: 'float'},{name: 'days6', type: 'int'},
                {name: 'area7', type: 'float'},{name: 'expenseArea7', type: 'float'},{name: 'days7', type: 'int'},
                {name: 'area8', type: 'float'},{name: 'expenseArea8', type: 'float'},{name: 'days8', type: 'int'},
                {name: 'area9', type: 'float'},{name: 'expenseArea9', type: 'float'},{name: 'days9', type: 'int'},
                {name: 'area10', type: 'float'},{name: 'expenseArea10', type: 'float'},{name: 'days10', type: 'int'},
                {name: 'area11', type: 'float'},{name: 'expenseArea11', type: 'float'},{name: 'days11', type: 'int'},
                {name: 'area12', type: 'float'},{name: 'expenseArea12', type: 'float'},{name: 'days12', type: 'int'},
                {name: 'area13', type: 'float'},{name: 'expenseArea13', type: 'float'},{name: 'days13', type: 'int'},
                {name: 'area14', type: 'float'},{name: 'expenseArea14', type: 'float'},{name: 'days14', type: 'int'},
                {name: 'area15', type: 'float'},{name: 'expenseArea15', type: 'float'},{name: 'days15', type: 'int'},
                {name: 'area16', type: 'float'},{name: 'expenseArea16', type: 'float'},{name: 'days16', type: 'int'},
                {name: 'area17', type: 'float'},{name: 'expenseArea17', type: 'float'},{name: 'days17', type: 'int'},
                {name: 'area18', type: 'float'},{name: 'expenseArea18', type: 'float'},{name: 'days18', type: 'int'},
                {name: 'area19', type: 'float'},{name: 'expenseArea19', type: 'float'},{name: 'days19', type: 'int'},
                {name: 'area20', type: 'float'},{name: 'expenseArea20', type: 'float'},{name: 'days20', type: 'int'},
