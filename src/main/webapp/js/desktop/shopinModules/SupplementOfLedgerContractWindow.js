...
//定义主界面
Ext.define("ShopinDesktop.SupplementOfLedgerContractWindow", {
	...
	saveEdit: function() {
		...
		if (editForm.isValid()) {
			//得到id，置为parentId
           	var tmpId = editForm.findField('id').getValue("id");
           	editForm.findField('parentId').setValue(tmpId);
           	editForm.findField('id').setValue(null);
